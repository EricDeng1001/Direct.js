...
export const __ASYNC_READ_USER_INFO = {
  pending: "USER/__READ_USER_INFO_PENDING",
  resolved: "USER/__READ_USER_INFO_RESOLVED",
  rejected: "USER/__READ_USER_INFO_REJECTED",
};
...
export const __TOGGLE_KEEP_LOGIN = "USR/__TOGGLE_KEEP_LOGIN";
